  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <Bell
          size={18}
          className={unreadCount > 0 ? "text-blue-600" : "text-gray-500"}
        />

        {unreadCount > 0 && (
          <div className="absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center bg-red-500 text-white border-0 rounded-full text-xs font-bold">
