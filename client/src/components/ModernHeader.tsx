  ...
  const searchResults = React.useMemo(() => {
    ...
    const filteredAchievements = achievements.filter((achievement) => {
      const attendant = attendants.find(
        (a) => a.id === achievement.attendantId
      );
      return (
          ...
          <div className="flex items-center justify-between header-adaptive">
            ...
            <div className="flex items-center space-adaptive">
              <div className="flex items-center space-adaptive">
                ...
                <div className="sm:hidden">
                  <h1 className="text-fluid-lg font-bold text-primary-light">
                    Sales
                  </h1>
                </div>
              </div>
            ...
            <div className="flex items-center space-adaptive">
              ...
              <div className="flex items-center space-adaptive">
                ...
                >
                  {isFullscreen ? (
                    <Minimize2 className="icon-adaptive" />
                  ) : (
                    <Maximize2 className="icon-adaptive" />
                  )}
                </Button>
                  ...
                  {searchResults.attendants.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2">
                        {searchResults.attendants
                          .slice(0, 3)
                          .map((attendant) => (
                            <div
                              key={attendant.id}
                              className="flex items-center gap-3 p-2 rounded-lg hover:bg-accent/30 cursor-pointer"
                            >
                              <img
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-xs text-secondary-light">
                                  R$ {attendant.earnings} em vendas
                                </p>
                              </div>
                            </div>
                          ))}
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {searchResults.sales.slice(0, 3).map((sale) => {
                          const attendant = attendants.find(
                            (a) => a.id === sale.attendantId
                          );
                          return (
                            <div
                              key={sale.id}
                              className="flex items-center justify-between p-2 rounded-lg hover:bg-accent/30 cursor-pointer"
                            >
                              <div>
                                <p className="text-sm font-medium text-primary-light">
                                  R$ {sale.value}
                      ...
                      <div className="space-y-2">
                        {searchResults.goals.slice(0, 3).map((goal) => {
                          ...
                          return (
                            <div
                              key={goal.id}
                              className="p-2 rounded-lg hover:bg-accent/30 cursor-pointer"
                            >
                              <p className="text-sm font-medium text-primary-light">
                                {goal.title}
                              </p>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Sons para novas vendas e conquistas
                  </p>
                </div>
              </div>
              <Switch
