...
export default function Attendants() {
  const [isNewAttendantDialogOpen, setIsNewAttendantDialogOpen] =
    useState(false);
  ...
  const attendantsWithStats =
    attendants?.map((attendant) => {
      ...
      const targetCompletion = Math.min(
        (totalValue / thisMonthTarget) * 100,
        100
      );
    ...
    <div className="min-h-screen bg-primary-dark">
      ...
      <main className="mobile-safe max-w-6xl py-4 sm:py-6 lg:py-8">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <Dialog
            open={isNewAttendantDialogOpen}
            onOpenChange={setIsNewAttendantDialogOpen}
          >
            ...
            <DialogContent className="bg-card border-border text-primary-light">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="imageUrl" className="text-secondary-light">
                    URL da Imagem
                  </Label>
                  <Input
                    id="imageUrl"
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-secondary-light">
                      Total R$ {attendant.totalValue.toFixed(2)}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-info">
                      R$ {attendant.thisMonthTarget.toFixed(2)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-secondary-light">
                    ...
                    <span className="font-medium text-secondary-light">
                      {attendant.targetCompletion.toFixed(0)}%
                    </span>
                  </div>
                </div>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-card border-border text-primary-light">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="editName" className="text-secondary-light">
                Nome
              </Label>
              <Input
                id="editName"
            ...
            <div>
              <Label htmlFor="editImageUrl" className="text-secondary-light">
                URL da Imagem
              </Label>
              <Input
                id="editImageUrl"
            ...
            <div className="flex gap-2">
              ...
              >
                {editAttendantMutation.isPending
                  ? "Atualizando..."
                  : "Atualizar"}
              </Button>
            </div>
