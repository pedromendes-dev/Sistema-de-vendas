...
export default function GoalsPage() {
  ...
  const getAttendantName = (attendantId: number) => {
    return (
      attendants?.find((a) => a.id === attendantId)?.name || "Desconhecido"
    );
  };
          ...
          >
            ...
            <DialogContent className="bg-card border-border text-primary-light max-w-md">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="attendant" className="text-secondary-light">
                    Atendente
                  </Label>
                  <Select
                ...
                <div>
                  <Label htmlFor="title" className="text-secondary-light">
                    Título da Meta
                  </Label>
                  <Input
                    id="title"
                ...
                <div>
                  <Label htmlFor="description" className="text-secondary-light">
                    Descrição
                  </Label>
                  <Textarea
                    id="description"
                ...
                <div>
                  <Label htmlFor="targetValue" className="text-secondary-light">
                    Valor da Meta (R$)
                  </Label>
                  <Input
                    id="targetValue"
                ...
                <div>
                  <Label htmlFor="goalType" className="text-secondary-light">
                    Tipo de Meta
                  </Label>
                  <Select
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="startDate" className="text-secondary-light">
                      Data de Início
                    </Label>
                    <Input
                      id="startDate"
                  ...
                  <div>
                    <Label htmlFor="endDate" className="text-secondary-light">
                      Data de Fim
                    </Label>
                    <Input
                      id="endDate"
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <Badge
                          variant="outline"
                          className="bg-white text-blue-700 border border-blue-300"
                        >
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-primary-light font-semibold">
                        R$ {parseFloat(goal.currentValue).toFixed(2)} / R${" "}
                        {parseFloat(goal.targetValue).toFixed(2)}
                      </span>
                    </div>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-secondary-light">
                        {getAttendantName(achievement.attendantId)}
                      </p>
                    </div>
                  </div>
