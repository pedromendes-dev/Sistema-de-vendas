...
export default function HistoryPage() {
  ...
  const totalValue =
    sales?.reduce((sum, sale) => sum + parseFloat(sale.value), 0) || 0;
  ...
  const filteredSales =
    sales?.filter((sale) => {
      if (
        ...
        sale.attendantId !== parseInt(selectedAttendant)
      ) {
        return false;
      }
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-secondary-light">
                Acompanhe todas as vendas realizadas pela equipe
              </p>
            </div>
          </div>
              ...
              {filteredSales.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-light text-sm">
                    Ajuste os filtros ou registre novas vendas
                  </p>
                </div>
              ) : (
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg font-mono text-primary-light">
                        #{selectedSale.id}
                      </p>
                    </div>
                    <Badge
